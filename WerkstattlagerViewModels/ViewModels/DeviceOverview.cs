...
public partial class DeviceOverview : ViewModelBase
{
    ...
    public DeviceOverview(IDbContextFactory<InventoryContext> dbContextFactory, ILogger<DeviceOverview>? logger = null) : base(logger, dbContextFactory)
    {
        _ = ReadDevices();
    }
