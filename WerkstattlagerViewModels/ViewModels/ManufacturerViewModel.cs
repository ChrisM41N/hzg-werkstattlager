...
{
    public partial class ManufacturerViewModel : ViewModelBase
    {
        ...
        public ManufacturerViewModel(IDbContextFactory<InventoryContext> dbContextFactory, ILogger<ManufacturerViewModel>? logger = null) : base(logger, dbContextFactory)
        {
            _ = ReadManufacturers();
        }
