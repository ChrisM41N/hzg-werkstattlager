...
public partial class CategoryOverview : ViewModelBase
{
    ...
    public CategoryOverview(IDbContextFactory<InventoryContext> dbContextFactory, ILogger<CategoryOverview>? logger = null) : base(logger, dbContextFactory)
    {
        _ = ReadCategories();
    }
