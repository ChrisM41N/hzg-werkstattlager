...
{
    public class ItemViewModelTest : TestBase, IClassFixture<DatabaseFixture>
    {
        private readonly ItemViewModel _inventory;
        private readonly DatabaseFixture _fixture;
        private readonly InventoryContext _context;

        public ItemViewModelTest(DatabaseFixture fixture, ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
            _fixture = fixture;
            _context = fixture.Context;
            _inventory = RootServiceProvider.GetRequiredService<ItemViewModel>();
        }
